exports.resetPasswordEmailTemplate = (name, email, token) => ({
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: Inter, Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                          ...
                          <h4>Hello ${name},</h4>
                          <h5>You requested to reset your password on Traffikr.IO</h5>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          <p style="margin: 0;">Tap the button below to reset your password. If you didn't make this request on <a href="${process.env.CLIENT_URL}">Traffikr.IO</a>, you can safely delete this email.</p>
                        </td>
                      </tr>
                      <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                      <a href="${process.env.CLIENT_URL}/reset-password/${token}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Reset Password</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          ...
                          <p style="margin: 0;"><a href="${process.env.CLIENT_URL}/reset-password/${token}" target="_blank">${process.env.CLIENT_URL}/reset-password/${token}</a></p>
                        </td>
                      </tr>
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                          <p style="margin: 0;">Kind regards,<br> Traffikr.IO</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                        <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                          <p style="margin: 0;">You received this email because we received a request a password reset for your account on Traffikr.IO. If you didn't request for a password reset, you can safely delete this email.</p>
                        </td>
                      </tr>
                      <tr>
                        <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
