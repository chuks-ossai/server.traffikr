...
exports.linkPublishedParams = (email, name, data) => ({
  Source: process.env.EMAIL_FROM,
  Destination: {
    ToAddresses: [email],
  },
        ...
        <!DOCTYPE html>
          <html lang='en'>
            ...
            <body style="background-color: #e9ecef;">
              ...
              <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
                This email is to notify you that a new link has been published on your favourite topics.
              </div>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                          ...
                          }" target="_blank" style="display: inline-block; text-decoration: none; font-family: Inter, sans-serif;">
                            <h1>Traffikr.IO</h1>
                          </a>
                        </td>
                      </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: Inter, Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                          ...
                          <h4>Hello ${name},</h4>
                          <h5>A new link titled ${
                            data.title
                          } has been published to the below categories</h5>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account with <a href="${
                            process.env.CLIENT_URL
                          }">Traffikr.IO</a>, you can safely delete this email.</p>
                        </td>
                      </tr>
                      <tr>
                        <td align="left" bgcolor="#ffffff">
                              ...
                              <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                ...
                                ${data.categories.map((category) => {
                                  ...
                                  <tr>
                                    <td align="center">
                                    <h3>${category.name}</h3>
                                    <div><img src="${category.img.url}" alt="${category.name}" height="50px" /></div>
                                    <h5>
                                    <a href="${process.env.CLIENT_URL}/links/${category.slug}" target="_blank">Check it out</a></h5>
                                    </td>
                                  </tr>
                                  `;
                                })}
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: Inter, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                          <p style="margin: 0;">Cheers,<br> <a href="${
                            process.env.CLIENT_URL
                          } target="_blank">Traffikr.IO</a></p>
                        </td>
                      </tr>
                    </table>
                  </td>
